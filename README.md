...
A lightweight Node.js server that serves lab reports matching the PLD Diagnostics format. Each QR code on the printed reports links to this server, which renders the patient's data in a pixel-accurate HTML replica of the original report.
...
4. Settings:
   ...
   - **Environment:** Node
5. Click **Deploy**
6. You get a URL like: `https://pld-reports.onrender.com`
...
Once you have a public URL (e.g. `https://pld-reports.onrender.com`), regenerate the QR codes in the PDFs to point to:

```
https://pld-reports.onrender.com/SLIMS.API/api/public/DownloadReport?labId=<ENDO_NO>&password=<PASSWORD>
```
